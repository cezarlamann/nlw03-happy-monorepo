...
import { OrphanageView } from '../interfaces/OrphanageView';
...
export default function OrphanageDetails() {
  ...
  function handleOpenGoogleMaps(orphanage: OrphanageView){
    const url = `https://www.google.com/maps/dir/?api=1&destination=${orphanage.latitude},${orphanage.longitude}`;
    Linking.openURL(url);
  }

  useEffect(() => {
    Api.get<OrphanageView>(`orphanages/${params.orphanageId}`)
    .then(response => {
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.mapContainer}>
          ...
          <RectButton onPress={() => handleOpenGoogleMaps(orphanage)} style={styles.routesContainer}>
